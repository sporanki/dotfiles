...
#format namenode depends on hdfs-site.xml
hdfs namenode -format

# BEFORE starting ensure current shell has the latest env sourced
# check java -version && $JAVA_HOME

# Before proceeding allow the ssh server to run see the appendix below fore more details
# see: Install ssh server
...
## Yarn/resourcemanager not running looked in /usr/local/Cellar/hadoop/2.8.1/libexec/logs/yarn-user-resourcemanager-macbook-pro-user.out

hmm. is it using an jvm??

Assertion failed at /Users/jenkins/workspace/build-scripts/jobs/jdk14u/jdk14u-mac-x64-openj9-macosXL/workspace/build/src/build/macosx-x86_64-server-release/vm/compiler/../omr/compiler/il/OMRBlock.cpp:1041: storeRegNodeInfoEntry != storeNodeInfo->end()
VMState: 0x000561ff
        We should have a regStore pre split point that can be used to allocate register for replacement node
compiling java/util/concurrent/locks/AbstractQueuedSynchronizer$ConditionObject.awaitNanos(J)J at level: very-hot (profiling)

JVMDUMP039I Processing dump event "abort", detail "" at 2020/06/19 18:12:20 - please wait.
JVMDUMP032I JVM requested System dump using '/usr/local/Cellar/hadoop/2.8.1/libexec/core.20200619.181220.41248.0001.dmp' in response to an event
JVMDUMP012E Error in System dump: The core file created by child process with pid = 41372 was not found. Expected to find core file with name "/cores/core.41372"
JVMDUMP032I JVM requested Java dump using '/usr/local/Cellar/hadoop/2.8.1/libexec/javacore.20200619.181220.41248.0002.txt' in response to an event
JVMDUMP010I Java dump written to /usr/local/Cellar/hadoop/2.8.1/libexec/javacore.20200619.181220.41248.0002.txt
JVMDUMP032I JVM requested Snap dump using '/usr/local/Cellar/hadoop/2.8.1/libexec/Snap.20200619.181220.41248.0003.trc' in response to an event
JVMDUMP010I Snap dump written to /usr/local/Cellar/hadoop/2.8.1/libexec/Snap.20200619.181220.41248.0003.trc
JVMDUMP007I JVM Requesting JIT dump using '/usr/local/Cellar/hadoop/2.8.1/libexec/jitdump.20200619.181220.41248.0004.dmp'
JVMDUMP010I JIT dump written to /usr/local/Cellar/hadoop/2.8.1/libexec/jitdump.20200619.181220.41248.0004.dmp
